...
export const CARDS: StoryCardDef[] = [
  ...
  },
  {
    ...
    title: "寄回第一笔钱", icon: "💌",
    text: "爹来信说，债主每月催一次，家里快撑不住了。这个月必须寄回 800 元。",
    window: [25, 70], deadlineDays: 7,
    solutions: [
      sol("yield", "打双份工", "白天干日结，晚上去网吧做兼职网管", { effects: { stamina: -45, stress: 8 }, goal: 800 }),
      ...
      sol("ignore", "先拖着", "下个月一起补", { conscience: -1, log: "这个月没寄钱，债主的电话打到了家里" }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("ignore", "再拖一个月", "谎称下个月发奖金", { conscience: -2, log: "你骗家里说下个月发奖金，夜里睡不踏实" }),
    ],
  ...
  // ---- 奶奶的手术费 ----
  {
    ...
    solutions: [
      ...
      sol("special", "老医生帮忙开便宜药", "社区老医生给你开了平价替代药", { requires: { npc: "npc_pharmacist", npcAffinity: 20 }, effects: { mood: 4 }, goal: 200 }),
    ],
    ignoreConsequence: { effects: { mood: -8 }, conscience: -2, log: "这个月没寄药费，奶奶停药三天" },
  },
  {
  ...
  },
  {
    ...
    window: [60, 120], deadlineDays: 7,
    solutions: [
      sol("special", "让老医生出具正规方案", "社区老医生帮你核对资质，揭穿骗局", { requires: { npc: "npc_pharmacist", npcAffinity: 30 }, effects: { mood: 5, intelligence: 1 }, conscience: 1 }),
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "老医生担保分期", "他愿意担保，先交一半", { requires: { npc: "npc_pharmacist", npcAffinity: 50 }, effects: { mood: 6 }, goal: 10000 }),
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "请王磊出面做思想工作", "他当过干部，一顿话说得弟弟低下了头", { requires: { npc: "npc_wang_lei", npcAffinity: 30 }, effects: { mood: 5 }, goal: 300, conscience: 1 }),
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "程序员小哥给他远程补课", "你认识的码农弟弟理科好，远程辅导", { requires: { contact: "library_coder" }, effects: { mood: 6 }, goal: 400, conscience: 1 }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "让程序员小哥帮忙拍照留档", "他帮你扫描备份，藏一份在云端", { requires: { contact: "library_coder" }, effects: { mood: 5, flags: { story_evidence_ledger: true } }, unlock: ["justice_s2"], conscience: 1 }),
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("ignore", "收下钱，就此罢手", "三万块，够家里过几年了", { effects: { money: 30000, mood: -10, flags: { story_evidence_bribe: true } }, conscience: -4, log: "你把钱寄回了家，夜里却梦见爹站在工地上看你" }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "陈姐托大厨指点你", "她认识的面点师傅偷空纠正了你的手法", { requires: { npc: "npc_chen_jie", npcAffinity: 25 }, effects: { mood: 4, skills: { cooking: 1 } } }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "陈姐帮忙说情，请师傅吃顿好的", "她替你张罗了一桌酒菜，师傅酒后多教了你两招", { requires: { npc: "npc_chen_jie", npcAffinity: 40 }, effects: { mood: 6, skills: { cooking: 2 } } }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "程序员小哥帮你发网帖", "他在本地论坛帮你宣传了铺子", { requires: { contact: "library_coder" }, effects: { fame: 4, mood: 4, skills: { cooking: 1 } } }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "让程序员小哥查查底细", "他查出这是个骗局，你躲过一劫", { requires: { contact: "library_coder" }, effects: { mood: 5, intelligence: 1 }, conscience: 1 }),
...

  {
    ...
    solutions: [
      ...
      sol("special", "老医生帮你写'防骗单'", "他把常见骗术写给你看", { requires: { npc: "npc_pharmacist", npcAffinity: 35 }, effects: { intelligence: 1, mood: 4 }, conscience: 1 }),
...

  {
    ...
    solutions: [
      ...
      sol("special", "请赵刚出面去接他", "赵刚路子野、讲义气，回老家顺路给弟弟撑了腰", { requires: { npc: "npc_zhao_gang", npcAffinity: 25 }, effects: { mood: 6 }, goal: 200, conscience: 1 }),
...

  {
    ...
    solutions: [
      ...
      sol("special", "王磊出面压阵", "他往门口一坐，对头气势就矮了半截", { requires: { npc: "npc_wang_lei", npcAffinity: 45 }, effects: { fame: 5, mood: 6 }, goal: 200, conscience: 1 }),
...

  {
    ...
    solutions: [
      ...
      sol("special", "陈姐帮你查了背景", "她说这人是出了名的骗子，专骗新来的", { requires: { npc: "npc_chen_jie", npcAffinity: 30 }, effects: { intelligence: 1, mood: 4 }, conscience: 1 }),
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "让程序员小哥查查", "他提醒你，最近有人拿复印件开卡", { requires: { contact: "library_coder" }, effects: { intelligence: 1, mood: 3 }, conscience: 1 }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "问清原因帮他想办法", "原来是孩子发烧，你请陈姐帮忙找了熟人诊所", { requires: { npc: "npc_chen_jie", npcAffinity: 35 }, effects: { mood: 5 }, conscience: 2 }),
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      sol("special", "请药房大哥上门看看", "他懂点医，先应急", { requires: { npc: "npc_pharmacist", npcAffinity: 40 }, effects: { mood: 6 }, conscience: 2 }),
    ],
