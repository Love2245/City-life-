...
<div class="region-grid-view hud-scope" style:background={glassBg}>
  <div class="head">
  ...
  <div class="grid">
    {#each regions as r (r.id)}
      ...
      >
        <span class="gi-emoji" style="font-size:48px;line-height:1">{r.icon}</span>
