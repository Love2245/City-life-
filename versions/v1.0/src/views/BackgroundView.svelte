<script lang="ts">
  import { newGame, goto, pendingState, profile, startStoryGame } from "../stores/gameStore.svelte";
...
<div class="page">
  ...
  <div class="mode-bar">
    ...
    {/each}
    <button class="mode-chip story" onclick={() => startStoryGame()}>🎬 剧情模式（v1.0 主线）</button>
  </div>
...
<style>
  ...
  .mode-chip.story {
    background: rgba(216, 132, 255, 0.12);
