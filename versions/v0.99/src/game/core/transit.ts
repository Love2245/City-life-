...
/** 载具优先级：汽车 > 三轮车 > 电动车 */
const VEHICLE_PRIORITY = ["car", "tricycle", "e_bike"] as const;
export type VehicleType = (typeof VEHICLE_PRIORITY)[number];

const VEHICLE_ICON: Record<VehicleType, string> = { car: "🚗", tricycle: "🛺", e_bike: "🛵" };
const VEHICLE_LABEL: Record<VehicleType, string> = { car: "开车", tricycle: "骑三轮车", e_bike: "骑电动车" };
const BUS_ICON = "🚌";
